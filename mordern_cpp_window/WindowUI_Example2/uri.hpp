...
//===========================================================================
inline std::wstring encode(const std::wstring& decodedString, bool retainLineFeed)
{
...
inline std::wstring decode(const std::wstring& encodedString)
{
...
void parse_query_string_parameters(const std::wstring& s, std::map<std::wstring, std::wstring>& parameter_map)
{
